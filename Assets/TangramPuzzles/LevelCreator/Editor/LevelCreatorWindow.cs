...
namespace BizzyBeeGames.TangramPuzzles
{
	public class LevelCreatorWindow : EditorWindow
	{
		...
		{
			get { return EditorPrefs.GetString("TangramPuzzles.LevelCreatorWindow.OutputFolderAssetPath", null); }
			set { EditorPrefs.SetString("TangramPuzzles.LevelCreatorWindow.OutputFolderAssetPath", value); }
		}
		...
		{
			string errorMessage = "An unexpected error occurred while generating levels. Please send this log message to support@bizzybeegames.com\n\n";
